...
/**
 * Signals that the configuration (commonly known in InTouch Meet as config.js)
...
/**
 * Signals that a configuration (commonly known in InTouch Meet as config.js)
...
/**
 * Stores a specific InTouch Meet config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The InTouch Meet config.js to store.
 * @returns {Function}
 */
