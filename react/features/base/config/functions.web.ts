...
export function _setDeeplinkingDefaults(deeplinking: IDeeplinkingConfig) {
    ...
    desktop.appName = desktop.appName || 'InTouch Meet';
    desktop.appScheme = desktop.appScheme || 'InTouch-meet';
