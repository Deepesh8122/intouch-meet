...
export default [
     ...
     * provided by, for example, InTouch Meet SDK for iOS.
     *
     * @type string
     */
    'callDisplayName',
     ...
     * override/overwrite provided by, for example, InTouch Meet SDK for iOS.
     *
     * @type string
     */
    'callHandle',
     ...
     * which InTouch Meet is to work with a CallKit call created outside of InTouch
     * Meet and to be adopted by InTouch Meet such as, for example, an incoming
     * and/or outgoing CallKit call created by InTouch Meet SDK for iOS
     * clients/consumers prior to giving control to InTouch Meet. As the value is
     * associated with a conference/meeting, the value makes sense not as a
     * deployment-wide configuration, only as a runtime configuration
     * override/overwrite provided by, for example, InTouch Meet SDK for iOS.
     *
