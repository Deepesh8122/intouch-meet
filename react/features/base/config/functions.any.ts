...
/**
 * Restores a InTouch Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The InTouch Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "InTouch Meet"
    // }
    // We want to have:
    // json = {
    //     config: {
