InTouch Meet - redux state persistence
====================================
InTouch Meet has a persistence layer that persists specific subtrees of the redux
...
When it's done, InTouch Meet will automatically persist these subtrees and
