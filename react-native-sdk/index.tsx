...
/**
 * Main React Native SDK component that displays a InTouch Meet conference and gets all required params as props
 */
export const JitsiMeeting = forwardRef<JitsiRefProps, IAppProps>((props, ref) => {
    ...
    useLayoutEffect(() => {
         ...
         * Without this change the call remains active without having the InTouch screen.
        */
        return () => {
            const dispatch = app.current?.state?.store?.dispatch;
